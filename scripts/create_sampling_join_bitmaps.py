...
#TODO: 这部分注释了imdb的连接映射关系，如果要生成连接位图，需要取消注释 by zjw
...
JOIN_COL_MAP = {}
JOIN_COL_MAP["badges.userid"] = "userid"
JOIN_COL_MAP["comments.userid"] = "userid"
JOIN_COL_MAP["posthistory.userid"] = "userid"
JOIN_COL_MAP["posts.owneruserid"] = "userid"
JOIN_COL_MAP["posts.lasteditoruserid"] = "userid"
JOIN_COL_MAP["users.id"] = "userid"
JOIN_COL_MAP["votes.userid"] = "userid"

JOIN_COL_MAP["comments.postid"] = "postid"
JOIN_COL_MAP["posts.id"] = "postid"
JOIN_COL_MAP["posthistory.postid"] = "postid"
JOIN_COL_MAP["postlinks.postid"] = "postid"
JOIN_COL_MAP["postlinks.relatedpostid"] = "postid"
JOIN_COL_MAP["tags.excerptpostid"] = "postid"
JOIN_COL_MAP["votes.postid"] = "postid"
